...
public class Sort {
    ...
    public static void quickSort(int[] a, int left, int right) {
        ...
        while (left != right) {
            while (a[right] >= a[originLeft] && left < right) {
                right--;
            }
            while (a[left] <= a[originLeft] && left < right) {
                left++;
            }
            if (left < right) {
                Utils.swapElement(a, left, right);
            }
        }
        Utils.swapElement(a, originLeft, right);
